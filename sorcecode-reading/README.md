...
---"[[http://java.sun.com/portlet_2_0>portlet_2_0.tld]]"はjavaの標準セット→[[portlet_2_0.tldのソース>portlet_2_0.tld]]
--prefixで接頭語を設定
---<portlet:～>で利用可能になる
-<portlet:defineObjects />
--[[portlet_2_0.tld]]で指定されたクラス「[[org.apache.pluto.tags.DefineObjectsTag286>DefineObjectsTag286.java]]」のdefineObjectsメソッドが実行される→[[DefineObjectsTag286.javaのソース>DefineObjectsTag286.java]]
---ポートレットに必要な初期設定を行う
...
--"[[http://liferay.com/tld/theme>liferay-theme.tld]]"はliferayの標準セット→[[liferay-theme.tldのソース>>liferay-theme.tld]]
-<liferay-theme:defineObjects />
--[[liferay-theme.tld]]で指定されたクラス「[[com.liferay.taglib.theme.DefineObjectsTag>DefineObjectsTag.java]]」のDefineObjectsメソッドが実行される→[[DefineObjectsTag.javaのソース>DefineObjectsTag.java]]
